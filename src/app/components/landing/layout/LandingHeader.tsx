    ...
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        isDark
          ? `${
              isScrolled
                ? "bg-[#0A0A0A]/95 backdrop-blur-xl shadow-2xl shadow-purple-900/20 border-b border-white/10"
                : "bg-transparent"
            }`
          : `${
              isScrolled
                ? "bg-white/95 backdrop-blur-xl shadow-2xl shadow-gray-300/50 border-b border-gray-200"
                : "bg-transparent"
            }`
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            >
              <Image
                src={isDark ? "/whitelogo500.svg" : "/blacklogo500.svg"}
                alt="Unext Logo"
                width={isScrolled ? 120 : 140}
                height={40}
                priority
                className="transition-all duration-500 w-auto h-full"
              />
            </div>
          </div>

          <nav
            className={`hidden md:flex items-center gap-2 rounded-full p-1.5 transition-colors ${
              isDark
            ...
            <button
              ...
              className={`px-6 py-2.5 rounded-full transition-all ${
                activeSection === "home"
                  ...
                  : "text-gray-600 hover:text-[#0A0A0A] hover:bg-gray-200"
              }`}
            >
              Inicio
            </button>
      ...
      {mobileMenuOpen && (
        <div
          className={`md:hidden backdrop-blur-xl transition-colors ${
            isDark
          ...
          <div className="px-4 py-6 space-y-3">
            ...
            <div className="pt-4 space-y-2">
              ...
              <Link href="/login" className="w-full">
                <button
                  className={`w-full px-6 py-3 transition-colors rounded-xl ${
                    isDark
                      ? "text-gray-300 hover:text-white hover:bg-white/5"
                      : "text-gray-700 hover:text-[#0A0A0A] hover:bg-gray-100"
                  }`}
