  ...
  return (
    <footer className={`relative transition-colors duration-500 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative">
        <div className="grid md:grid-cols-5 gap-12 mb-12">
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className={`text-2xl ${isDark ? 'text-white' : 'text-[#0A0A0A]'}`}>
                Unext
              </span>
            </div>
            ...
            <div className="flex gap-3">
              <a href="#" className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all ${
                isDark 
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className={`flex items-center gap-2 ${
                ...
                <Mail className={`w-5 h-5 ${isDark ? 'text-purple-500' : 'text-purple-700'}`} />
                <span>hola@unext.com</span>
              </li>
              <li className={`flex items-center gap-2 ${
                isDark ? 'text-gray-400' : 'text-gray-600'
              }`}>
                <Phone className={`w-5 h-5 ${isDark ? 'text-purple-500' : 'text-purple-700'}`} />
        ...
        <div className={`border-t pt-8 flex flex-col md:flex-row justify-between items-center gap-4 transition-colors duration-500 ${
